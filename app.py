...
def predict():
    ...
    features = [data["lead_time"], data["same_room"], data["cancelled"], data["special_requests"], data["booking_changes"]]
    ...
    if output == 0:
        result = "Reservation is Canceled"
    else:
        result = "Reservation is not Canceled"
